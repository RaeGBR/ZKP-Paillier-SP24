...
TEST(Paillier, EncryptionDecryption2)
{
  ...
  EXPECT_EQ(encryptor->getPublicKey()->toHex(), decryptor->getPublicKey()->toHex());
  EXPECT_EQ(encryptor->getGroupQ()->toHex(), decryptor->getGroupQ()->toHex());
  EXPECT_EQ(encryptor->getGroupP()->toHex(), decryptor->getGroupP()->toHex());
  EXPECT_EQ(encryptor->getGroupG()->toHex(), decryptor->getGroupG()->toHex());
